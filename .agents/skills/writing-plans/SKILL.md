...
**Save plans to:** `kb/<repo>/exec-plans/active/<feature-name>/plan.md`
...
**"Plan complete and saved to `kb/<repo>/exec-plans/active/<feature>/plan.md`. Two execution options:**
